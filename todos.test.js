...
describe('todos', () => {
    ...
    describe("API Todo Test", () => {
        ...
        test("POST /todos/:id to modify properties returns status 200 and the following JSON", async () => {
            // Create a new todo and test if it was sucessfully created
        ...
        test("PUT /todos/:id to modify properties returns status 200 and the following JSON", async () => {
            // Create a new todo and test if it was sucessfully created
            let req = require('./res/todos/post_todos_req.json');
            let response = await axios.post(todoUrl, req);
            const newTodoId = response.data.id;
        ...
        test("POST /todos/:id to set doneStatus to true returns status 200 and the following JSON", async () => {
            // Create a new todo and test if it was sucessfully created
            let req = require('./res/todos/post_todos_req.json');
            let response = await axios.post(todoUrl, req);
            const newTodoId = response.data.id;
        ...
        test("[BUG] PUT /todos/:id to set doneStatus to true returns status 200 and the following JSON", async () => {
            // Create a new todo and test if it was sucessfully created
            let req = require('./res/todos/post_todos_req.json');
            let response = await axios.post(todoUrl, req);
            const newTodoId = response.data.id;
